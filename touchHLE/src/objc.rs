...
pub use messages::{
    autorelease, dump_msg_ring, msg, msg_class, msg_send, msg_send_no_initialize,
    msg_send_no_type_checking, msg_send_super2, msg_super, objc_super, release, retain,
};
...
pub const DYLIB: HostDylib = HostDylib {
    ...
    function_exports: &[FUNCTIONS, arc::FUNCTIONS],
};
